...
void main()
{
    ...
    gl_Position = ProjectionMatrix * ViewMatrix * ModelMatrix * TEPosition;

    // Convert to camera cooridnates
    TEPosition = ViewMatrix * ModelMatrix * TEPosition;
